...
namespace PrecursorShell.Commands.GenerateDonkeyCache
{
    ...
    partial class GenerateDonkeyCacheCommand : PrecursorCommand
    {
        public object RebuildCache(string destCacheDirectory)
        {
            ...
            SetCacheVersion(cacheContext, CacheVersion.Eldorado106708);
        ...
        public void RetargetCache(string cache)
        {
            ...
            // TODO: Modify so we can pass the cache into the context factory
            ContextStack.Push(PrecursorContextFactory.Create(ContextStack));
        }
        ...
        public CachedTag GetCachedTag<T>(string tagName) where T : TagStructure
        {
            ...
            {
                new PrecursorWarning($@"Could not find tag: '{tagName}.{typeName}'. Assinging null tag instead");
                return null;
            }
        }
    }
