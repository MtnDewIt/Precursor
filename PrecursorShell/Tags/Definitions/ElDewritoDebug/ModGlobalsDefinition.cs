...
namespace PrecursorShell.Tags.Definitions.ElDewritoDebug
{
    ...
    public class ModGlobalsDefinition : TagStructure 
    {
        ...
        public class PlayerCharacterSet : TagStructure
        {
            ...
            public List<TagTool.Tags.Definitions.ModGlobalsDefinition.PlayerCharacterSet.PlayerCharacter> Characters;
        }
        ...
        public class PlayerCharacterCustomization : TagStructure
        {
            ...
            public TagTool.Tags.Definitions.ModGlobalsDefinition.PlayerCharacterCustomization.PlayerCharacterColors CharacterColors;
            ...
            {
                public TagTool.Tags.Definitions.ModGlobalsDefinition.PlayerCharacterCustomization.CharacterPositionInfo.FlagsValue Flags;
