...
namespace Precursor.Tests.BlfTests.HaloOnlineED06
{
    [TestClass]
    public class HaloOnlineED06GameVariants
    {
        private const string ResourcePath = @"Resources\HaloOnline\HaloOnlineED06\game_variants";

        private const CacheVersion Version = CacheVersion.HaloOnline106708;
