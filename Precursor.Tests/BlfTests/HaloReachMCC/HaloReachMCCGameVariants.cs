...
namespace Precursor.Tests.BlfTests.HaloReachMCC
{
    [TestClass]
    public class HaloReachMCCGameVariants
    {
        private const string ResourcePath = @"Resources\MCC\HaloReachMCC\game_variants";

        private const CacheVersion Version = CacheVersion.HaloReach;
        private const CachePlatform Platform = CachePlatform.MCC;
