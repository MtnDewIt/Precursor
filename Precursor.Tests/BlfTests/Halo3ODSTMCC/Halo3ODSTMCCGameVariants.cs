...
namespace Precursor.Tests.BlfTests.Halo3ODSTMCC
{
    [TestClass]
    public class Halo3ODSTMCCGameVariants
    {
        private const string ResourcePath = @"Resources\MCC\Halo3MCC\game_variants";

        private const CacheVersion Version = CacheVersion.Halo3ODST;
