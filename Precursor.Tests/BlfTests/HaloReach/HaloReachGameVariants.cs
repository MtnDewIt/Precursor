...
namespace Precursor.Tests.BlfTests.HaloReach
{
    [TestClass]
    public class HaloReachGameVariants
    {
        private const string ResourcePath = @"Resources\Gen3\HaloReach\game_variants";
