...
namespace Precursor.Tests.BlfTests.Halo2MCC
{
    [TestClass]
    public class Halo2MCCGameVariants
    {
        private const string ResourcePath = @"Resources\MCC\Halo2MCC\game_variants";

        private const CacheVersion Version = CacheVersion.Halo2PC;
