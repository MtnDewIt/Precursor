...
namespace Precursor.Tests.BlfTests.Halo1MCC
{
    [TestClass]
    public class Halo1MCCGameVariants
    {
        private const string ResourcePath = @"Resources\MCC\Halo1MCC\game_variants";

        private const CacheVersion Version = CacheVersion.HaloCustomEdition;
