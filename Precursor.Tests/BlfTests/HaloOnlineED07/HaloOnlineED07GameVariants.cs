...
namespace Precursor.Tests.BlfTests.HaloOnlineED07
{
    [TestClass]
    public class HaloOnlineED07GameVariants
    {
        private const string ResourcePath = @"Resources\HaloOnline\HaloOnlineED07\game_variants";

        private const CacheVersion Version = CacheVersion.HaloOnlineED;
