...
namespace Precursor.Tests.BlfTests.Halo3Retail
{
    [TestClass]
    public class Halo3RetailGameVariants
    {
        private const string ResourcePath = @"Resources\Gen3\Halo3Retail\game_variants";
