...
namespace Precursor.Tests.BlfTests.HaloOnline106708
{
    [TestClass]
    public class HaloOnline106708Films
    {
        private const string ResourcePath = @"Resources\HaloOnline\HaloOnline106708\films";
