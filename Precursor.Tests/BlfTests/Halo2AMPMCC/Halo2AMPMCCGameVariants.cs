...
namespace Precursor.Tests.BlfTests.Halo2AMPMCC
{
    [TestClass]
    public class Halo2AMPMCCGameVariants
    {
        private const string ResourcePath = @"Resources\MCC\Halo2AMPMCC\game_variants";

        private const CacheVersion Version = CacheVersion.H2AMP;
