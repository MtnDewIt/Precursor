...
namespace Precursor.Tests.Cache.BuildInfo.Gen1
{
    public class HaloCustomEditionInfo : BuildTableEntry
    {
        public override CacheBuild Build => CacheBuild.HaloCustomEdition;
