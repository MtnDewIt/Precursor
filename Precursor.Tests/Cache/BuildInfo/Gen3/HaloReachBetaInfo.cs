...
{
    public class HaloReachBetaInfo : BuildTableEntry
    {
        public override CacheBuild Build => CacheBuild.HaloReachBeta;
        public override CacheVersion Version => CacheVersion.HaloReachBeta;
