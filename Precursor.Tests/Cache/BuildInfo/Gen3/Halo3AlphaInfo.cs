...
{
    internal class Halo3AlphaInfo : BuildTableEntry
    {
        public override CacheBuild Build => CacheBuild.Halo3Alpha;
        public override CacheVersion Version => CacheVersion.Halo3Alpha;
        ...
        {
            "06481.06.11.17.1330.alpha_relea",
        };
