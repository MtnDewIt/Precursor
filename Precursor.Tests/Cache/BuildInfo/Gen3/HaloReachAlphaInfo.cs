...
{
    public class HaloReachAlphaInfo : BuildTableEntry
    {
        public override CacheBuild Build => CacheBuild.HaloReachAlpha;
        public override CacheVersion Version => CacheVersion.HaloReachAlpha;
