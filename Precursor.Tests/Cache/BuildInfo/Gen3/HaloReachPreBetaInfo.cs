...
{
    public class HaloReachPreBetaInfo : BuildTableEntry
    {
        public override CacheBuild Build => CacheBuild.HaloReachPreBeta;
        public override CacheVersion Version => CacheVersion.HaloReachPreBeta;
