...
namespace Precursor.Tests.Cache.BuildInfo.Gen3
{
    public class Halo3PreAlphaInfo : BuildTableEntry
    {
        public override CacheBuild Build => CacheBuild.Halo3PreAlpha;
        public override CacheVersion Version => CacheVersion.Halo3PreAlpha;
        ...
        {
            "05241.06.09.21.1534.first_playt",
        };
