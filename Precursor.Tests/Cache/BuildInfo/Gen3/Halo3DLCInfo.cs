...
{
    public class Halo3DLCInfo : BuildTableEntry
    {
        public override CacheBuild Build => CacheBuild.Halo3DLC;
        public override CacheVersion Version => CacheVersion.Halo3DLC;
