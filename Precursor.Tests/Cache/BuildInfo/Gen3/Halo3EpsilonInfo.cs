...
{
    public class Halo3EpsilonInfo : BuildTableEntry
    {
        public override CacheBuild Build => CacheBuild.Halo3Epsilon;
        public override CacheVersion Version => CacheVersion.Halo3Epsilon;
