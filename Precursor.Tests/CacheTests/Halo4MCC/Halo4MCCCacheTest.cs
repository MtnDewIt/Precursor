...
namespace Precursor.Tests.CacheTests.Halo4MCC
{
    [TestClass]
    public class Halo4MCCCacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.Halo4MCC);
