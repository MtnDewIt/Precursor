...
namespace Precursor.Tests.CacheTests.Halo3ODST
{
    [TestClass]
    public class Halo3ODSTCacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.Halo3ODST);
