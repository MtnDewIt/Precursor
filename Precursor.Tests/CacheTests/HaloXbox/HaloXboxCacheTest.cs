...
namespace Precursor.Tests.CacheTests.HaloXbox
{
    [TestClass]
    public class HaloXboxCacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.HaloXbox);
