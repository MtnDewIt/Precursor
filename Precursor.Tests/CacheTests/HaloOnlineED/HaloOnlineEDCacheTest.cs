...
namespace Precursor.Tests.CacheTests.HaloOnlineED
{
    [TestClass]
    public class HaloOnlineEDCacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.HaloOnlineED);
