...
namespace Precursor.Tests.CacheTests.HaloOnline700255
{
    [TestClass]
    public class HaloOnline700255CacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.HaloOnline700255);
