...
namespace Precursor.Tests.CacheTests.Halo4Retail
{
    [TestClass]
    public class Halo4RetailCacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.Halo4Retail);
