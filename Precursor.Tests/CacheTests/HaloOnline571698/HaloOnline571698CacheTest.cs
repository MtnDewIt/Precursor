...
namespace Precursor.Tests.CacheTests.HaloOnline571698
{
    [TestClass]
    public class HaloOnline571698CacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.HaloOnline571698);
