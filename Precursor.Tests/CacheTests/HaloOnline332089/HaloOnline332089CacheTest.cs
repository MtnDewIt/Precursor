...
namespace Precursor.Tests.CacheTests.HaloOnline332089
{
    [TestClass]
    public class HaloOnline332089CacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.HaloOnline332089);
