...
namespace Precursor.Tests.CacheTests.Halo3March9Delta
{
    [TestClass]
    public class Halo3March9DeltaCacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.Halo3March9Delta);
