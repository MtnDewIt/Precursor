...
namespace Precursor.Tests.CacheTests.HaloReachPreBeta
{
    [TestClass]
    public class HaloReachPreBetaCacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.HaloReachPreBeta);
