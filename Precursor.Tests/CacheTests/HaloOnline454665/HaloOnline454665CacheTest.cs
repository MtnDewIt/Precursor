...
namespace Precursor.Tests.CacheTests.HaloOnline454665
{
    [TestClass]
    public class HaloOnline454665CacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.HaloOnline454665);
