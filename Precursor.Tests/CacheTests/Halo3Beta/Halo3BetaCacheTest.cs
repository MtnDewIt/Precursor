...
namespace Precursor.Tests.CacheTests.Halo3Beta
{
    [TestClass]
    public class Halo3BetaCacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.Halo3Beta);
