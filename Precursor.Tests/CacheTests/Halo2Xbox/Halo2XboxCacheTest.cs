...
namespace Precursor.Tests.CacheTests.Halo2Xbox
{
    [TestClass]
    public class Halo2XboxCacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.Halo2Xbox);
