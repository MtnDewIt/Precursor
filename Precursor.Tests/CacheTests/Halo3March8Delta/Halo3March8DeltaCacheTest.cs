...
namespace Precursor.Tests.CacheTests.Halo3March8Delta
{
    [TestClass]
    public class Halo3March8DeltaCacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.Halo3March8Delta);
