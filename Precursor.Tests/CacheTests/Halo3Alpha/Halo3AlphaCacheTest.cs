...
namespace Precursor.Tests.CacheTests.Halo3Alpha
{
    [TestClass]
    public class Halo3AlphaCacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.Halo3Alpha);
