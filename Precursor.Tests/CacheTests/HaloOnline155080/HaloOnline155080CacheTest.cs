...
namespace Precursor.Tests.CacheTests.HaloOnline155080
{
    [TestClass]
    public class HaloOnline155080CacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.HaloOnline155080);
