...
namespace Precursor.Tests.CacheTests.HaloReach
{
    [TestClass]
    public class HaloReachCacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.HaloReach);
