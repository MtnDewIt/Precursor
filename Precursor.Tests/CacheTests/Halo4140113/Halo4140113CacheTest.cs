...
namespace Precursor.Tests.CacheTests.Halo4140113
{
    [TestClass]
    public class Halo4140113CacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.Halo4140113);
