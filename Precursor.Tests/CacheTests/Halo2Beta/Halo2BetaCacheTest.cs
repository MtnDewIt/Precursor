...
namespace Precursor.Tests.CacheTests.Halo2Beta
{
    [TestClass]
    public class Halo2BetaCacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.Halo2Beta);
