...
namespace Precursor.Tests.CacheTests.Halo4280911
{
    [TestClass]
    public class Halo4280911CacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.Halo4280911);
