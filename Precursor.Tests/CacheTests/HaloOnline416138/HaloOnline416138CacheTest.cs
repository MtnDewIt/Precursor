...
namespace Precursor.Tests.CacheTests.HaloOnline416138
{
    [TestClass]
    public class HaloOnline416138CacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.HaloOnline416138);
