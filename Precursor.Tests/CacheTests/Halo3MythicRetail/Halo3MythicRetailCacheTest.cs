...
namespace Precursor.Tests.CacheTests.Halo3MythicRetail
{
    [TestClass]
    public class Halo3MythicRetailCacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.Halo3MythicRetail);
