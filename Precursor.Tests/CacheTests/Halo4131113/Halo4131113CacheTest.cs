...
namespace Precursor.Tests.CacheTests.Halo4131113
{
    [TestClass]
    public class Halo4131113CacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.Halo4131113);
