...
namespace Precursor.Tests.CacheTests.HaloCustomEdition
{
    [TestClass]
    public class HaloCustomEditionCacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.HaloCustomEdition);
