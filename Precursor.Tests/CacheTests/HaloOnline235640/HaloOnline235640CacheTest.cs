...
namespace Precursor.Tests.CacheTests.HaloOnline235640
{
    [TestClass]
    public class HaloOnline235640CacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.HaloOnline235640);
