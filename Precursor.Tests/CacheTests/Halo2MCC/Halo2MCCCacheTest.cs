...
namespace Precursor.Tests.CacheTests.Halo2MCC
{
    [TestClass]
    public class Halo2MCCCacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.Halo2MCC);
