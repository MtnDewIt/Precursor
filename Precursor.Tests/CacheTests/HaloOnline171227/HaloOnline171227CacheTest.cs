...
namespace Precursor.Tests.CacheTests.HaloOnline171227
{
    [TestClass]
    public class HaloOnline171227CacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.HaloOnline171227);
