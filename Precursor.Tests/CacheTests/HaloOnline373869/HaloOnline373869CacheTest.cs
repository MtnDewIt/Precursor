...
namespace Precursor.Tests.CacheTests.HaloOnline373869
{
    [TestClass]
    public class HaloOnline373869CacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.HaloOnline373869);
