...
namespace Precursor.Tests.CacheTests.HaloOnline177150
{
    [TestClass]
    public class HaloOnline177150CacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.HaloOnline177150);
