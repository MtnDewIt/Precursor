...
namespace Precursor.Tests.CacheTests.HaloOnline604673
{
    [TestClass]
    public class HaloOnline604673CacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.HaloOnline604673);
