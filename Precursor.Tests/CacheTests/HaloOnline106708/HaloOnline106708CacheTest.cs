...
namespace Precursor.Tests.CacheTests.HaloOnline106708
{
    [TestClass]
    public class HaloOnline106708CacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.HaloOnline106708);
