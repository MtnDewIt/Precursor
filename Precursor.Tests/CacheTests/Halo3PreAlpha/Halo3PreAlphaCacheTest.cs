...
namespace Precursor.Tests.CacheTests.Halo3PreAlpha
{
    [TestClass]
    public class Halo3PreAlphaCacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.Halo3PreAlpha);
