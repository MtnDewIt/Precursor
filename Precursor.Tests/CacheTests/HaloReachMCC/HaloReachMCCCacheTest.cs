...
namespace Precursor.Tests.CacheTests.HaloReachMCC
{
    [TestClass]
    public class HaloReachMCCCacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.HaloReachMCC);
