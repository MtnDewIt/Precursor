...
namespace Precursor.Tests.CacheTests.HaloOnline301003
{
    [TestClass]
    public class HaloOnline301003CacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.HaloOnline301003);
