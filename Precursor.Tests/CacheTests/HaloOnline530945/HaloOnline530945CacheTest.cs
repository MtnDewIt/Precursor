...
namespace Precursor.Tests.CacheTests.HaloOnline530945
{
    [TestClass]
    public class HaloOnline530945CacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.HaloOnline530945);
