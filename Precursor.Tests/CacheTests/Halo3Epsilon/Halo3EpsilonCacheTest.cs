...
namespace Precursor.Tests.CacheTests.Halo3Epsilon
{
    [TestClass]
    public class Halo3EpsilonCacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.Halo3Epsilon);
