...
namespace Precursor.Tests.CacheTests.HaloReach11883
{
    [TestClass]
    public class HaloReach11883CacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.HaloReach11883);
