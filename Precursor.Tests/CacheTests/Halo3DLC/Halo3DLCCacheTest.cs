...
namespace Precursor.Tests.CacheTests.Halo3DLC
{
    [TestClass]
    public class Halo3DLCCacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.Halo3DLC);
