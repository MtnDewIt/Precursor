...
namespace Precursor.Tests.CacheTests.HaloOnline430653
{
    [TestClass]
    public class HaloOnline430653CacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.HaloOnline430653);
