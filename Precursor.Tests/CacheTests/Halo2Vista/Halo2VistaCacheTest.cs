...
namespace Precursor.Tests.CacheTests.Halo2Vista
{
    [TestClass]
    public class Halo2VistaCacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.Halo2Vista);
