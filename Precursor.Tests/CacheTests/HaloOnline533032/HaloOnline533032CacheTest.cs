...
namespace Precursor.Tests.CacheTests.HaloOnline533032
{
    [TestClass]
    public class HaloOnline533032CacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.HaloOnline533032);
