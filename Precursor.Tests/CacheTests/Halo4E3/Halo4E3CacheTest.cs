...
namespace Precursor.Tests.CacheTests.Halo4E3
{
    [TestClass]
    public class Halo4E3CacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.Halo4E3);
