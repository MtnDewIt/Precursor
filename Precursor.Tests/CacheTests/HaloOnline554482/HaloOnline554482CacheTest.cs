...
namespace Precursor.Tests.CacheTests.HaloOnline554482
{
    [TestClass]
    public class HaloOnline554482CacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.HaloOnline554482);
