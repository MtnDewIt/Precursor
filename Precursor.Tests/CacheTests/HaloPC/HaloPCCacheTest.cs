...
namespace Precursor.Tests.CacheTests.HaloPC
{
    [TestClass]
    public class HaloPCCacheTest
    {
        private static BuildTableConfig.BuildTableEntry Build = Globals.BuildTableConfig.Builds.FirstOrDefault(x => x.Build == CacheBuild.HaloPC);
