...
namespace Precursor.Tags.Definitions
{
    public class TagDefinitionValidator
    {
        ...
        public void VerifyStringId(StringId stringId)
        {
        ...
        public static bool IsValidReal(float r)
        {
