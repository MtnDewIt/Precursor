...
namespace Precursor.Commands.GenerateDonkeyCache
{
    partial class GenerateDonkeyCacheCommand : PrecursorCommand
    {
        ...
        public void InitializePortingContext()
        {
            ...
            h3MainMenu = new PortingContextGen3(CacheContext, h3MainMenuCache, CacheStream);
            intro = new PortingContextGen3(CacheContext, introCache, CacheStream);
            jungle = new PortingContextGen3(CacheContext, jungleCache, CacheStream);
            crows = new PortingContextGen3(CacheContext, crowsCache, CacheStream);
            outskirts = new PortingContextGen3(CacheContext, outskirtsCache, CacheStream);
            voi = new PortingContextGen3(CacheContext, voiCache, CacheStream);
            floodvoi = new PortingContextGen3(CacheContext, floodvoiCache, CacheStream);
            waste = new PortingContextGen3(CacheContext, wasteCache, CacheStream);
            citadel = new PortingContextGen3(CacheContext, citadelCache, CacheStream);
            highCharity = new PortingContextGen3(CacheContext, highCharityCache, CacheStream);
            halo = new PortingContextGen3(CacheContext, haloCache, CacheStream);
            epilogue = new PortingContextGen3(CacheContext, epilogueCache, CacheStream);

            mythicMainMenu = new PortingContextGen3(CacheContext, mythicMainMenuCache, CacheStream);
            armory = new PortingContextGen3(CacheContext, armoryCache, CacheStream);
            bunkerworld = new PortingContextGen3(CacheContext, bunkerworldCache, CacheStream);
            chill = new PortingContextGen3(CacheContext, chillCache, CacheStream);
            chillout = new PortingContextGen3(CacheContext, chilloutCache, CacheStream);
            construct = new PortingContextGen3(CacheContext, constructCache, CacheStream);
            cyberdyne = new PortingContextGen3(CacheContext, cyberdyneCache, CacheStream);
            deadlock = new PortingContextGen3(CacheContext, deadlockCache, CacheStream);
            descent = new PortingContextGen3(CacheContext, descentCache, CacheStream);
            docks = new PortingContextGen3(CacheContext, docksCache, CacheStream);
            fortress = new PortingContextGen3(CacheContext, fortressCache, CacheStream);
            ghosttown = new PortingContextGen3(CacheContext, ghosttownCache, CacheStream);
            guardian = new PortingContextGen3(CacheContext, guardianCache, CacheStream);
            isolation = new PortingContextGen3(CacheContext, isolationCache, CacheStream);
            lockout = new PortingContextGen3(CacheContext, lockoutCache, CacheStream);
            midship = new PortingContextGen3(CacheContext, midshipCache, CacheStream);
            riverworld = new PortingContextGen3(CacheContext, riverworldCache, CacheStream);
            salvation = new PortingContextGen3(CacheContext, salvationCache, CacheStream);
            sandbox = new PortingContextGen3(CacheContext, sandboxCache, CacheStream);
            shrine = new PortingContextGen3(CacheContext, shrineCache, CacheStream);
            sidewinder = new PortingContextGen3(CacheContext, sidewinderCache, CacheStream);
            snowbound = new PortingContextGen3(CacheContext, snowboundCache, CacheStream);
            spacecamp = new PortingContextGen3(CacheContext, spacecampCache, CacheStream);
            warehouse = new PortingContextGen3(CacheContext, warehouseCache, CacheStream);
            zanzibar = new PortingContextGen3(CacheContext, zanzibarCache, CacheStream);

            odstMainMenu = new PortingContextGen3(CacheContext, odstMainMenuCache, CacheStream);
            h100 = new PortingContextGen3(CacheContext, h100Cache, CacheStream);
            c100 = new PortingContextGen3(CacheContext, c100Cache, CacheStream);
            c200 = new PortingContextGen3(CacheContext, c200Cache, CacheStream);
            l200 = new PortingContextGen3(CacheContext, l200Cache, CacheStream);
            l300 = new PortingContextGen3(CacheContext, l300Cache, CacheStream);
            sc100 = new PortingContextGen3(CacheContext, sc100Cache, CacheStream);
            sc110 = new PortingContextGen3(CacheContext, sc110Cache, CacheStream);
            sc120 = new PortingContextGen3(CacheContext, sc120Cache, CacheStream);
            sc130 = new PortingContextGen3(CacheContext, sc130Cache, CacheStream);
            sc140 = new PortingContextGen3(CacheContext, sc140Cache, CacheStream);
            sc150 = new PortingContextGen3(CacheContext, sc150Cache, CacheStream);
        }
